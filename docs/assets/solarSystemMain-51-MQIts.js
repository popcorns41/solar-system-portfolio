import{C as ue,V as m,M as D,T as M,Q as H,S as Y,a as c,R as ce,P as de,b as fe,c as F,O as pe,B as j,F as G,d as b,U as R,W as x,H as w,N as U,e as me,f as S,A as K,g as ge,h as ve,D as V,i as _e,j as xe,k as be,l as Se,m as we,n as Te,o as ye,p as Me,q as De,r as Ee,s as q,t as $,u as Ce,v as Pe,w as Be,x as J,G as ee,E as te,L as ie,y as se,z as Le,I as Oe,J as Re}from"./index-BtGNlAOE.js";const Z={type:"change"},N={type:"start"},ae={type:"end"},O=new ce,Q=new de,Ae=Math.cos(70*fe.DEG2RAD),g=new m,_=2*Math.PI,f={NONE:-1,ROTATE:0,DOLLY:1,PAN:2,TOUCH_ROTATE:3,TOUCH_PAN:4,TOUCH_DOLLY_PAN:5,TOUCH_DOLLY_ROTATE:6},z=1e-6;class ke extends ue{constructor(e,t=null){super(e,t),this.state=f.NONE,this.target=new m,this.cursor=new m,this.minDistance=0,this.maxDistance=1/0,this.minZoom=0,this.maxZoom=1/0,this.minTargetRadius=0,this.maxTargetRadius=1/0,this.minPolarAngle=0,this.maxPolarAngle=Math.PI,this.minAzimuthAngle=-1/0,this.maxAzimuthAngle=1/0,this.enableDamping=!1,this.dampingFactor=.05,this.enableZoom=!0,this.zoomSpeed=1,this.enableRotate=!0,this.rotateSpeed=1,this.keyRotateSpeed=1,this.enablePan=!0,this.panSpeed=1,this.screenSpacePanning=!0,this.keyPanSpeed=7,this.zoomToCursor=!1,this.autoRotate=!1,this.autoRotateSpeed=2,this.keys={LEFT:"ArrowLeft",UP:"ArrowUp",RIGHT:"ArrowRight",BOTTOM:"ArrowDown"},this.mouseButtons={LEFT:D.ROTATE,MIDDLE:D.DOLLY,RIGHT:D.PAN},this.touches={ONE:M.ROTATE,TWO:M.DOLLY_PAN},this.target0=this.target.clone(),this.position0=this.object.position.clone(),this.zoom0=this.object.zoom,this._domElementKeyEvents=null,this._lastPosition=new m,this._lastQuaternion=new H,this._lastTargetPosition=new m,this._quat=new H().setFromUnitVectors(e.up,new m(0,1,0)),this._quatInverse=this._quat.clone().invert(),this._spherical=new Y,this._sphericalDelta=new Y,this._scale=1,this._panOffset=new m,this._rotateStart=new c,this._rotateEnd=new c,this._rotateDelta=new c,this._panStart=new c,this._panEnd=new c,this._panDelta=new c,this._dollyStart=new c,this._dollyEnd=new c,this._dollyDelta=new c,this._dollyDirection=new m,this._mouse=new c,this._performCursorZoom=!1,this._pointers=[],this._pointerPositions={},this._controlActive=!1,this._onPointerMove=Ue.bind(this),this._onPointerDown=ze.bind(this),this._onPointerUp=Fe.bind(this),this._onContextMenu=Ve.bind(this),this._onMouseWheel=Ie.bind(this),this._onKeyDown=He.bind(this),this._onTouchStart=Ye.bind(this),this._onTouchMove=Ge.bind(this),this._onMouseDown=je.bind(this),this._onMouseMove=Ne.bind(this),this._interceptControlDown=Ze.bind(this),this._interceptControlUp=Qe.bind(this),this.domElement!==null&&this.connect(this.domElement),this.update()}connect(e){super.connect(e),this.domElement.addEventListener("pointerdown",this._onPointerDown),this.domElement.addEventListener("pointercancel",this._onPointerUp),this.domElement.addEventListener("contextmenu",this._onContextMenu),this.domElement.addEventListener("wheel",this._onMouseWheel,{passive:!1}),this.domElement.getRootNode().addEventListener("keydown",this._interceptControlDown,{passive:!0,capture:!0}),this.domElement.style.touchAction="none"}disconnect(){this.domElement.removeEventListener("pointerdown",this._onPointerDown),this.domElement.removeEventListener("pointermove",this._onPointerMove),this.domElement.removeEventListener("pointerup",this._onPointerUp),this.domElement.removeEventListener("pointercancel",this._onPointerUp),this.domElement.removeEventListener("wheel",this._onMouseWheel),this.domElement.removeEventListener("contextmenu",this._onContextMenu),this.stopListenToKeyEvents(),this.domElement.getRootNode().removeEventListener("keydown",this._interceptControlDown,{capture:!0}),this.domElement.style.touchAction="auto"}dispose(){this.disconnect()}getPolarAngle(){return this._spherical.phi}getAzimuthalAngle(){return this._spherical.theta}getDistance(){return this.object.position.distanceTo(this.target)}listenToKeyEvents(e){e.addEventListener("keydown",this._onKeyDown),this._domElementKeyEvents=e}stopListenToKeyEvents(){this._domElementKeyEvents!==null&&(this._domElementKeyEvents.removeEventListener("keydown",this._onKeyDown),this._domElementKeyEvents=null)}saveState(){this.target0.copy(this.target),this.position0.copy(this.object.position),this.zoom0=this.object.zoom}reset(){this.target.copy(this.target0),this.object.position.copy(this.position0),this.object.zoom=this.zoom0,this.object.updateProjectionMatrix(),this.dispatchEvent(Z),this.update(),this.state=f.NONE}update(e=null){const t=this.object.position;g.copy(t).sub(this.target),g.applyQuaternion(this._quat),this._spherical.setFromVector3(g),this.autoRotate&&this.state===f.NONE&&this._rotateLeft(this._getAutoRotationAngle(e)),this.enableDamping?(this._spherical.theta+=this._sphericalDelta.theta*this.dampingFactor,this._spherical.phi+=this._sphericalDelta.phi*this.dampingFactor):(this._spherical.theta+=this._sphericalDelta.theta,this._spherical.phi+=this._sphericalDelta.phi);let i=this.minAzimuthAngle,s=this.maxAzimuthAngle;isFinite(i)&&isFinite(s)&&(i<-Math.PI?i+=_:i>Math.PI&&(i-=_),s<-Math.PI?s+=_:s>Math.PI&&(s-=_),i<=s?this._spherical.theta=Math.max(i,Math.min(s,this._spherical.theta)):this._spherical.theta=this._spherical.theta>(i+s)/2?Math.max(i,this._spherical.theta):Math.min(s,this._spherical.theta)),this._spherical.phi=Math.max(this.minPolarAngle,Math.min(this.maxPolarAngle,this._spherical.phi)),this._spherical.makeSafe(),this.enableDamping===!0?this.target.addScaledVector(this._panOffset,this.dampingFactor):this.target.add(this._panOffset),this.target.sub(this.cursor),this.target.clampLength(this.minTargetRadius,this.maxTargetRadius),this.target.add(this.cursor);let a=!1;if(this.zoomToCursor&&this._performCursorZoom||this.object.isOrthographicCamera)this._spherical.radius=this._clampDistance(this._spherical.radius);else{const n=this._spherical.radius;this._spherical.radius=this._clampDistance(this._spherical.radius*this._scale),a=n!=this._spherical.radius}if(g.setFromSpherical(this._spherical),g.applyQuaternion(this._quatInverse),t.copy(this.target).add(g),this.object.lookAt(this.target),this.enableDamping===!0?(this._sphericalDelta.theta*=1-this.dampingFactor,this._sphericalDelta.phi*=1-this.dampingFactor,this._panOffset.multiplyScalar(1-this.dampingFactor)):(this._sphericalDelta.set(0,0,0),this._panOffset.set(0,0,0)),this.zoomToCursor&&this._performCursorZoom){let n=null;if(this.object.isPerspectiveCamera){const l=g.length();n=this._clampDistance(l*this._scale);const o=l-n;this.object.position.addScaledVector(this._dollyDirection,o),this.object.updateMatrixWorld(),a=!!o}else if(this.object.isOrthographicCamera){const l=new m(this._mouse.x,this._mouse.y,0);l.unproject(this.object);const o=this.object.zoom;this.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/this._scale)),this.object.updateProjectionMatrix(),a=o!==this.object.zoom;const h=new m(this._mouse.x,this._mouse.y,0);h.unproject(this.object),this.object.position.sub(h).add(l),this.object.updateMatrixWorld(),n=g.length()}else console.warn("WARNING: OrbitControls.js encountered an unknown camera type - zoom to cursor disabled."),this.zoomToCursor=!1;n!==null&&(this.screenSpacePanning?this.target.set(0,0,-1).transformDirection(this.object.matrix).multiplyScalar(n).add(this.object.position):(O.origin.copy(this.object.position),O.direction.set(0,0,-1).transformDirection(this.object.matrix),Math.abs(this.object.up.dot(O.direction))<Ae?this.object.lookAt(this.target):(Q.setFromNormalAndCoplanarPoint(this.object.up,this.target),O.intersectPlane(Q,this.target))))}else if(this.object.isOrthographicCamera){const n=this.object.zoom;this.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/this._scale)),n!==this.object.zoom&&(this.object.updateProjectionMatrix(),a=!0)}return this._scale=1,this._performCursorZoom=!1,a||this._lastPosition.distanceToSquared(this.object.position)>z||8*(1-this._lastQuaternion.dot(this.object.quaternion))>z||this._lastTargetPosition.distanceToSquared(this.target)>z?(this.dispatchEvent(Z),this._lastPosition.copy(this.object.position),this._lastQuaternion.copy(this.object.quaternion),this._lastTargetPosition.copy(this.target),!0):!1}_getAutoRotationAngle(e){return e!==null?_/60*this.autoRotateSpeed*e:_/60/60*this.autoRotateSpeed}_getZoomScale(e){const t=Math.abs(e*.01);return Math.pow(.95,this.zoomSpeed*t)}_rotateLeft(e){this._sphericalDelta.theta-=e}_rotateUp(e){this._sphericalDelta.phi-=e}_panLeft(e,t){g.setFromMatrixColumn(t,0),g.multiplyScalar(-e),this._panOffset.add(g)}_panUp(e,t){this.screenSpacePanning===!0?g.setFromMatrixColumn(t,1):(g.setFromMatrixColumn(t,0),g.crossVectors(this.object.up,g)),g.multiplyScalar(e),this._panOffset.add(g)}_pan(e,t){const i=this.domElement;if(this.object.isPerspectiveCamera){const s=this.object.position;g.copy(s).sub(this.target);let a=g.length();a*=Math.tan(this.object.fov/2*Math.PI/180),this._panLeft(2*e*a/i.clientHeight,this.object.matrix),this._panUp(2*t*a/i.clientHeight,this.object.matrix)}else this.object.isOrthographicCamera?(this._panLeft(e*(this.object.right-this.object.left)/this.object.zoom/i.clientWidth,this.object.matrix),this._panUp(t*(this.object.top-this.object.bottom)/this.object.zoom/i.clientHeight,this.object.matrix)):(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - pan disabled."),this.enablePan=!1)}_dollyOut(e){this.object.isPerspectiveCamera||this.object.isOrthographicCamera?this._scale/=e:(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),this.enableZoom=!1)}_dollyIn(e){this.object.isPerspectiveCamera||this.object.isOrthographicCamera?this._scale*=e:(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),this.enableZoom=!1)}_updateZoomParameters(e,t){if(!this.zoomToCursor)return;this._performCursorZoom=!0;const i=this.domElement.getBoundingClientRect(),s=e-i.left,a=t-i.top,n=i.width,l=i.height;this._mouse.x=s/n*2-1,this._mouse.y=-(a/l)*2+1,this._dollyDirection.set(this._mouse.x,this._mouse.y,1).unproject(this.object).sub(this.object.position).normalize()}_clampDistance(e){return Math.max(this.minDistance,Math.min(this.maxDistance,e))}_handleMouseDownRotate(e){this._rotateStart.set(e.clientX,e.clientY)}_handleMouseDownDolly(e){this._updateZoomParameters(e.clientX,e.clientX),this._dollyStart.set(e.clientX,e.clientY)}_handleMouseDownPan(e){this._panStart.set(e.clientX,e.clientY)}_handleMouseMoveRotate(e){this._rotateEnd.set(e.clientX,e.clientY),this._rotateDelta.subVectors(this._rotateEnd,this._rotateStart).multiplyScalar(this.rotateSpeed);const t=this.domElement;this._rotateLeft(_*this._rotateDelta.x/t.clientHeight),this._rotateUp(_*this._rotateDelta.y/t.clientHeight),this._rotateStart.copy(this._rotateEnd),this.update()}_handleMouseMoveDolly(e){this._dollyEnd.set(e.clientX,e.clientY),this._dollyDelta.subVectors(this._dollyEnd,this._dollyStart),this._dollyDelta.y>0?this._dollyOut(this._getZoomScale(this._dollyDelta.y)):this._dollyDelta.y<0&&this._dollyIn(this._getZoomScale(this._dollyDelta.y)),this._dollyStart.copy(this._dollyEnd),this.update()}_handleMouseMovePan(e){this._panEnd.set(e.clientX,e.clientY),this._panDelta.subVectors(this._panEnd,this._panStart).multiplyScalar(this.panSpeed),this._pan(this._panDelta.x,this._panDelta.y),this._panStart.copy(this._panEnd),this.update()}_handleMouseWheel(e){this._updateZoomParameters(e.clientX,e.clientY),e.deltaY<0?this._dollyIn(this._getZoomScale(e.deltaY)):e.deltaY>0&&this._dollyOut(this._getZoomScale(e.deltaY)),this.update()}_handleKeyDown(e){let t=!1;switch(e.code){case this.keys.UP:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateUp(_*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(0,this.keyPanSpeed),t=!0;break;case this.keys.BOTTOM:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateUp(-_*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(0,-this.keyPanSpeed),t=!0;break;case this.keys.LEFT:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateLeft(_*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(this.keyPanSpeed,0),t=!0;break;case this.keys.RIGHT:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateLeft(-_*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(-this.keyPanSpeed,0),t=!0;break}t&&(e.preventDefault(),this.update())}_handleTouchStartRotate(e){if(this._pointers.length===1)this._rotateStart.set(e.pageX,e.pageY);else{const t=this._getSecondPointerPosition(e),i=.5*(e.pageX+t.x),s=.5*(e.pageY+t.y);this._rotateStart.set(i,s)}}_handleTouchStartPan(e){if(this._pointers.length===1)this._panStart.set(e.pageX,e.pageY);else{const t=this._getSecondPointerPosition(e),i=.5*(e.pageX+t.x),s=.5*(e.pageY+t.y);this._panStart.set(i,s)}}_handleTouchStartDolly(e){const t=this._getSecondPointerPosition(e),i=e.pageX-t.x,s=e.pageY-t.y,a=Math.sqrt(i*i+s*s);this._dollyStart.set(0,a)}_handleTouchStartDollyPan(e){this.enableZoom&&this._handleTouchStartDolly(e),this.enablePan&&this._handleTouchStartPan(e)}_handleTouchStartDollyRotate(e){this.enableZoom&&this._handleTouchStartDolly(e),this.enableRotate&&this._handleTouchStartRotate(e)}_handleTouchMoveRotate(e){if(this._pointers.length==1)this._rotateEnd.set(e.pageX,e.pageY);else{const i=this._getSecondPointerPosition(e),s=.5*(e.pageX+i.x),a=.5*(e.pageY+i.y);this._rotateEnd.set(s,a)}this._rotateDelta.subVectors(this._rotateEnd,this._rotateStart).multiplyScalar(this.rotateSpeed);const t=this.domElement;this._rotateLeft(_*this._rotateDelta.x/t.clientHeight),this._rotateUp(_*this._rotateDelta.y/t.clientHeight),this._rotateStart.copy(this._rotateEnd)}_handleTouchMovePan(e){if(this._pointers.length===1)this._panEnd.set(e.pageX,e.pageY);else{const t=this._getSecondPointerPosition(e),i=.5*(e.pageX+t.x),s=.5*(e.pageY+t.y);this._panEnd.set(i,s)}this._panDelta.subVectors(this._panEnd,this._panStart).multiplyScalar(this.panSpeed),this._pan(this._panDelta.x,this._panDelta.y),this._panStart.copy(this._panEnd)}_handleTouchMoveDolly(e){const t=this._getSecondPointerPosition(e),i=e.pageX-t.x,s=e.pageY-t.y,a=Math.sqrt(i*i+s*s);this._dollyEnd.set(0,a),this._dollyDelta.set(0,Math.pow(this._dollyEnd.y/this._dollyStart.y,this.zoomSpeed)),this._dollyOut(this._dollyDelta.y),this._dollyStart.copy(this._dollyEnd);const n=(e.pageX+t.x)*.5,l=(e.pageY+t.y)*.5;this._updateZoomParameters(n,l)}_handleTouchMoveDollyPan(e){this.enableZoom&&this._handleTouchMoveDolly(e),this.enablePan&&this._handleTouchMovePan(e)}_handleTouchMoveDollyRotate(e){this.enableZoom&&this._handleTouchMoveDolly(e),this.enableRotate&&this._handleTouchMoveRotate(e)}_addPointer(e){this._pointers.push(e.pointerId)}_removePointer(e){delete this._pointerPositions[e.pointerId];for(let t=0;t<this._pointers.length;t++)if(this._pointers[t]==e.pointerId){this._pointers.splice(t,1);return}}_isTrackingPointer(e){for(let t=0;t<this._pointers.length;t++)if(this._pointers[t]==e.pointerId)return!0;return!1}_trackPointer(e){let t=this._pointerPositions[e.pointerId];t===void 0&&(t=new c,this._pointerPositions[e.pointerId]=t),t.set(e.pageX,e.pageY)}_getSecondPointerPosition(e){const t=e.pointerId===this._pointers[0]?this._pointers[1]:this._pointers[0];return this._pointerPositions[t]}_customWheelEvent(e){const t=e.deltaMode,i={clientX:e.clientX,clientY:e.clientY,deltaY:e.deltaY};switch(t){case 1:i.deltaY*=16;break;case 2:i.deltaY*=100;break}return e.ctrlKey&&!this._controlActive&&(i.deltaY*=10),i}}function ze(r){this.enabled!==!1&&(this._pointers.length===0&&(this.domElement.setPointerCapture(r.pointerId),this.domElement.addEventListener("pointermove",this._onPointerMove),this.domElement.addEventListener("pointerup",this._onPointerUp)),!this._isTrackingPointer(r)&&(this._addPointer(r),r.pointerType==="touch"?this._onTouchStart(r):this._onMouseDown(r)))}function Ue(r){this.enabled!==!1&&(r.pointerType==="touch"?this._onTouchMove(r):this._onMouseMove(r))}function Fe(r){switch(this._removePointer(r),this._pointers.length){case 0:this.domElement.releasePointerCapture(r.pointerId),this.domElement.removeEventListener("pointermove",this._onPointerMove),this.domElement.removeEventListener("pointerup",this._onPointerUp),this.dispatchEvent(ae),this.state=f.NONE;break;case 1:const e=this._pointers[0],t=this._pointerPositions[e];this._onTouchStart({pointerId:e,pageX:t.x,pageY:t.y});break}}function je(r){let e;switch(r.button){case 0:e=this.mouseButtons.LEFT;break;case 1:e=this.mouseButtons.MIDDLE;break;case 2:e=this.mouseButtons.RIGHT;break;default:e=-1}switch(e){case D.DOLLY:if(this.enableZoom===!1)return;this._handleMouseDownDolly(r),this.state=f.DOLLY;break;case D.ROTATE:if(r.ctrlKey||r.metaKey||r.shiftKey){if(this.enablePan===!1)return;this._handleMouseDownPan(r),this.state=f.PAN}else{if(this.enableRotate===!1)return;this._handleMouseDownRotate(r),this.state=f.ROTATE}break;case D.PAN:if(r.ctrlKey||r.metaKey||r.shiftKey){if(this.enableRotate===!1)return;this._handleMouseDownRotate(r),this.state=f.ROTATE}else{if(this.enablePan===!1)return;this._handleMouseDownPan(r),this.state=f.PAN}break;default:this.state=f.NONE}this.state!==f.NONE&&this.dispatchEvent(N)}function Ne(r){switch(this.state){case f.ROTATE:if(this.enableRotate===!1)return;this._handleMouseMoveRotate(r);break;case f.DOLLY:if(this.enableZoom===!1)return;this._handleMouseMoveDolly(r);break;case f.PAN:if(this.enablePan===!1)return;this._handleMouseMovePan(r);break}}function Ie(r){this.enabled===!1||this.enableZoom===!1||this.state!==f.NONE||(r.preventDefault(),this.dispatchEvent(N),this._handleMouseWheel(this._customWheelEvent(r)),this.dispatchEvent(ae))}function He(r){this.enabled!==!1&&this._handleKeyDown(r)}function Ye(r){switch(this._trackPointer(r),this._pointers.length){case 1:switch(this.touches.ONE){case M.ROTATE:if(this.enableRotate===!1)return;this._handleTouchStartRotate(r),this.state=f.TOUCH_ROTATE;break;case M.PAN:if(this.enablePan===!1)return;this._handleTouchStartPan(r),this.state=f.TOUCH_PAN;break;default:this.state=f.NONE}break;case 2:switch(this.touches.TWO){case M.DOLLY_PAN:if(this.enableZoom===!1&&this.enablePan===!1)return;this._handleTouchStartDollyPan(r),this.state=f.TOUCH_DOLLY_PAN;break;case M.DOLLY_ROTATE:if(this.enableZoom===!1&&this.enableRotate===!1)return;this._handleTouchStartDollyRotate(r),this.state=f.TOUCH_DOLLY_ROTATE;break;default:this.state=f.NONE}break;default:this.state=f.NONE}this.state!==f.NONE&&this.dispatchEvent(N)}function Ge(r){switch(this._trackPointer(r),this.state){case f.TOUCH_ROTATE:if(this.enableRotate===!1)return;this._handleTouchMoveRotate(r),this.update();break;case f.TOUCH_PAN:if(this.enablePan===!1)return;this._handleTouchMovePan(r),this.update();break;case f.TOUCH_DOLLY_PAN:if(this.enableZoom===!1&&this.enablePan===!1)return;this._handleTouchMoveDollyPan(r),this.update();break;case f.TOUCH_DOLLY_ROTATE:if(this.enableZoom===!1&&this.enableRotate===!1)return;this._handleTouchMoveDollyRotate(r),this.update();break;default:this.state=f.NONE}}function Ve(r){this.enabled!==!1&&r.preventDefault()}function Ze(r){r.key==="Control"&&(this._controlActive=!0,this.domElement.getRootNode().addEventListener("keyup",this._interceptControlUp,{passive:!0,capture:!0}))}function Qe(r){r.key==="Control"&&(this._controlActive=!1,this.domElement.getRootNode().removeEventListener("keyup",this._interceptControlUp,{passive:!0,capture:!0}))}const B={name:"CopyShader",uniforms:{tDiffuse:{value:null},opacity:{value:1}},vertexShader:`
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`,blending:K,depthTest:!1,depthWrite:!1,transparent:!0})}}y.BlurDirectionX=new c(1,0);y.BlurDirectionY=new c(0,1);const tt={name:"FXAAShader",uniforms:{tDiffuse:{value:null},resolution:{value:new c(1/1024,1/512)}},vertexShader:`
		...
		}`};function it(){console.log("Create the scene");const r=new be,e=new S(1184274);r.background=e,console.log("Create a perspective projection camera");var t=new Se(45,window.innerWidth/window.innerHeight,.1,1e3);t.position.set(-175,115,5);const i=document.getElementById("threeCanvas"),s=new we({canvas:i,antialias:!0,alpha:!0,preserveDrawingBuffer:!0});console.log("Create the renderer"),s.setClearColor(0,0),s.setSize(window.innerWidth,window.innerHeight),s.setPixelRatio(window.devicePixelRatio),s.shadowMap.enabled=!0,s.shadowMap.type=Te,console.log("Create an orbit control");const a=new ke(t,s.domElement);return a.enableDamping=!0,a.dampingFactor=.75,a.screenSpacePanning=!1,a.maxDistance=600,{scene:r,camera:t,renderer:s,controls:a,canvas:i}}function st(r,e,t){const i=new x(window.innerWidth,window.innerHeight,{format:Me,type:ye,depthBuffer:!0,stencilBuffer:!1}),s=new $e(r,i);s.addPass(new et(e,t));const a=new re(tt),n=r.getPixelRatio();a.material.uniforms.resolution.value.set(1/(window.innerWidth*n),1/(window.innerHeight*n)),s.addPass(a);const l=new y(new c(window.innerWidth,window.innerHeight),e,t);l.edgeStrength=3,l.edgeGlow=1,l.visibleEdgeColor.set(16777215),l.hiddenEdgeColor.set(1640965),s.addPass(l);const o=new E(new c(window.innerWidth,window.innerHeight),1e-4,.4,.001);return o.renderToScreen=!0,o.clear=!1,o.threshold=1,o.radius=.9,s.addPass(o),{composer:s,outlinePass:l,fxaaPass:a}}function at(r){console.log("Add the ambient light");var e=new De(2236962,6);const t=new Ee(16777215,2236962,.2);r.add(e),r.add(t)}function rt(r,e,t){r.add(e),t.forEach(i=>{r.add(i.planet3d)}),window.dispatchEvent(new CustomEvent("planetsLoaded"))}const ot="/solar-system-portfolio/images/sun.jpg",nt="/solar-system-portfolio/images/8ball.jpg",oe=new Ce;function lt(r){r.forEach(e=>{e.planet3d.visible=!1})}function ht(r){r.scale.set(1.7,1.7,1.7),r.position.y=-50,r.position.z=0,r.position.x=0}function ut(){let e;const t=new q(17.425,64,64);e=new $({emissive:16775311,emissiveMap:oe.load(ot),emissiveIntensity:1,color:new S(16753920)}),e.transparent=!0;const i=new F(t,e);window.dispatchEvent(new CustomEvent("sunLoaded"));const s=new Pe(16646099,1200,400,1.4);return s.shadow.mapSize.width=1024,s.shadow.mapSize.height=1024,s.shadow.camera.near=10,s.shadow.camera.far=20,i.add(s),i.planet=i,window.dispatchEvent(new CustomEvent("sunLoaded")),i}async function ct(){const r=await P("mercury",40,.2);r.planet.rotation.x=-90*Math.PI/180;const e=await P("venus",65,6.1),t=new dt("Earth",6.4,90,0,nt),i=await P("mars",110,4),s=await P("jupiter",140,15),a=await P("saturn",200,1);t.planet.castShadow=!0,t.planet.receiveShadow=!0,r.planet.castShadow=!0,r.planet.receiveShadow=!0,e.planet.castShadow=!0,e.planet.receiveShadow=!0,i.planet.castShadow=!0,i.planet.receiveShadow=!0,s.planet.castShadow=!0,s.planet.receiveShadow=!0,a.planet.castShadow=!0,a.planet.receiveShadow=!0;const n=[{name:"mercury",planet:r.planet,planet3d:r.planet3d,meshes:r.meshes,rotationSpeed:.005,orbitSpeed:.002,orbit:r.orbit,label:"Resume",rotateSelf:(l,o,h)=>l.rotateZ(o*h)},{name:"venus",planet:e.planet,planet3d:e.planet3d,meshes:e.meshes,rotationSpeed:.005,orbitSpeed:6e-4,orbit:e.orbit,label:"Skill sets",rotateSelf:(l,o,h)=>l.rotateY(o*h)},{name:"earth",planet:t.planet,planet3d:t.planet3d,meshes:t.meshes,rotationSpeed:.005,orbitSpeed:.001,orbit:t.orbit,label:"Robotics",rotateSelf:(l,o,h)=>l.rotateY(o*h)},{name:"mars",planet:i.planet,planet3d:i.planet3d,meshes:i.meshes,rotationSpeed:.008,orbitSpeed:.0012,orbit:i.orbit,label:"Extracurricular",rotateSelf:(l,o,h)=>l.rotateY(o*h)},{name:"jupiter",planet:s.planet,planet3d:s.planet3d,meshes:s.meshes,rotationSpeed:.005,orbitSpeed:3e-4,orbit:s.orbit,label:"Childhood",rotateSelf:(l,o,h)=>l.rotateY(o*h)},{name:"saturn",planet:a.planet,planet3d:a.planet3d,meshes:a.meshes,rotationSpeed:.01,orbitSpeed:2e-4,orbit:a.orbit,label:"About me",rotateSelf:(l,o,h)=>l.rotateY(o*h)}];return ft(n),n}function dt(r,e,t,i,s){let a;s instanceof Le?a=s:a=new Oe({map:oe.load(s)});const n=r,l=new q(e,32,20),o=new F(l,a),h=new J,u=new ee;u.add(o),o.position.x=t,o.rotation.z=i*Math.PI/180;const p=new te(0,0,t,t,0,2*Math.PI,!1,0).getPoints(100),T=new j().setFromPoints(p),k=new ie({color:16777215,transparent:!0,opacity:.5}),L=new se(T,k);return L.rotation.x=Math.PI/2,o.orbit=L,u.add(L),h.add(u),{name:n,planet:o,planet3d:h,orbit:L,meshes:[o]}}async function P(r,e,t){const i=await Be(r);i.traverse(p=>{p.isMesh&&(p.material=new $({map:p.material.map,color:p.material.color}),p.geometry.computeVertexNormals())});const s=new J,a=new ee;a.add(i),i.position.x=e,i.scale.set(t,t,t);const l=new te(0,0,e,e,0,2*Math.PI,!1,0).getPoints(100),o=new j().setFromPoints(l),h=new ie({color:16777215,transparent:!0,opacity:.5}),u=new se(o,h);u.rotation.x=Math.PI/2,i.orbit=u,a.add(u),s.add(a);let v=[];return i.traverse(p=>{p.isMesh&&v.push(p)}),{name:r,planet:i,planet3d:s,orbit:u,meshes:v}}function ft(r){for(let e=0;e<r.length;e++)r[e].planet3d.traverse(i=>{(i.isMesh||i.isLine)&&(i.material.transparent=!0)})}const d={isZoomingOut:!1,isMovingTowardsPlanet:!1,targetCameraPosition:new m,hoverEnabled:!0,offset:0,hasMouseMove:!1,mouse:new c},A={accelerationOrbit:1,acceleration:1};class pt{constructor({sun:e,planets:t,camera:i,controls:s,outlinePass:a,offsets:n,canvas:l}){this.raycaster=new Re,this.sun=e,this.sunMat=e.material,this.planets=t,this.camera=i,this.controls=s,this.outlinePass=a,this.offsets=n,this.canvas=l,this.raycastTargets=this.planets.flatMap(o=>o.meshes),this.raycastTargets.unshift(this.sun),this.onClick=this.onClick.bind(this),this.onMouseMove=this.onMouseMove.bind(this)}onClick(e){e.preventDefault(),d.mouse.x=e.clientX/window.innerWidth*2-1,d.mouse.y=-(e.clientY/window.innerHeight)*2+1,this.raycaster.setFromCamera(d.mouse,this.camera);const t=this.raycaster.intersectObjects(this.raycastTargets);if(t.length>0){const i=t[0].object,s=gt(i,this.sunMat,this.planets);let a=null;if(s===0?a=this.sun:s>0&&(a=this.planets[s-1]),a){window.planetIndex=s,d.offset=this.offsets[s];const n=new CustomEvent("solarSystemToInfoSection",{detail:{index:window.planetIndex}});window.dispatchEvent(n),A.accelerationOrbit=0;const l=new m;if(a!==this.sun){const h=new CustomEvent("changeSunOpacity",{detail:{opacity:0,duration:1e3}});this.canvas.dispatchEvent(h),a.planet.getWorldPosition(l)}window.dispatchEvent(new CustomEvent("circularBorder")),d.isMovingTowardsPlanet=!0,this.controls.target.copy(l),this.camera.lookAt(l),d.targetCameraPosition.copy(l).add(this.camera.position.clone().sub(l).normalize().multiplyScalar(d.offset));const o=new CustomEvent("hideOutofViewPlanets",{detail:{selectedPlanet:a,delay:300}});this.canvas.dispatchEvent(o),setTimeout(()=>{window.dispatchEvent(new CustomEvent("beginPlanetTransform"))},1e3),d.hoverEnabled=!1,d.hasMouseMove=!1,document.getElementById("hoverCard").style.display="none",this.outlinePass.selectedObjects=[]}}}onMouseMove(e){if(!d.hoverEnabled)return;d.hasMouseMove=!0,e.preventDefault(),d.mouse.x=e.clientX/window.innerWidth*2-1,d.mouse.y=-(e.clientY/window.innerHeight)*2+1,this.raycaster.setFromCamera(d.mouse,this.camera);const t=this.raycaster.intersectObjects(this.raycastTargets),i=document.getElementById("hoverCard");if(t.length>0){const s=t[0].object;i.style.left=`${e.clientX+10}px`,i.style.top=`${e.clientY+10}px`,i.style.display="block",s&&vt(s,i,this.sun,this.planets)}else i.innerText="",i.style.display="none"}attach(){this.canvas.addEventListener("click",this.onClick,!1),this.canvas.addEventListener("mousemove",this.onMouseMove,!1)}detach(){this.canvas.removeEventListener("click",this.onClick),this.canvas.removeEventListener("mousemove",this.onMouseMove)}}function mt(r,e){let t=r;for(;t;){if(t===e)return!0;t=t.parent}return!1}function gt(r,e,t){if(r.material===e)return 0;for(let i=0;i<t.length;i++)if(t[i].planet&&mt(r,t[i].planet))return i+1;return null}function vt(r,e,t,i){if(r===t){e.innerText="Contact me",e.style.display="block";return}for(const s of i)if(s.meshes.includes(r)){e.innerText=s.label,e.style.display="block";return}console.log(r,"not found!"),e.innerText="",e.style.display="none"}function _t(r){const e=r.position.y,t=45,i=8e3,s=performance.now();function a(n){const l=n-s,o=Math.min(l/i,1),h=1-Math.pow(1-o,2);r.position.y=e+(t-e)*h,o<1?requestAnimationFrame(a):window.dispatchEvent(new CustomEvent("sunRose"))}requestAnimationFrame(a)}function xt(r){const e=r.position.y,t=0,i=r.scale.x,s=1,a=2500,n=performance.now();function l(o){const h=o-n,u=Math.min(h/a,1),v=u*u*(3-2*u);r.position.y=e+(t-e)*v;const p=i+(s-i)*v;r.scale.set(p,p,p),u<1?requestAnimationFrame(l):window.dispatchEvent(new CustomEvent("sunZoomComplete"))}requestAnimationFrame(l)}function bt(r,e,t=1e3){if(!r)return;r.transparent=!0;const i=r.opacity,s=performance.now();function a(n){const l=n-s,o=Math.min(l/t,1),h=o*o*(3-2*o);r.opacity=i+(e-i)*h,o<1&&requestAnimationFrame(a)}requestAnimationFrame(a)}function St(r,e,t){const i=r===e;e.material.transparent=!0,e.material.opacity=i?1:0,t.forEach((s,a)=>{const n=s.planet;if(!n)return;const l=s===r;n.traverse(o=>{(o.isMesh||o.isLine)&&o.material&&((Array.isArray(o.material)?o.material:[o.material]).forEach(u=>{u.transparent=!0,u.opacity=l?1:0}),o.visible=!0)})})}function wt(r,e,t=300,i=1e3){console.log("selectedPlanet",r);for(let s=e.length-1;s>=0;s--){const a=e[s].planet3d,l=e[s].planet===r.planet;setTimeout(()=>{if(l){if(r.orbit&&r.orbit.material){let u=function(v){const p=v-h,T=Math.min(p/i,1),k=T*T*(3-2*T);o.opacity=1-k,T<1?requestAnimationFrame(u):r.orbit.visible=!1};const o=r.orbit.material;o.transparent=!0;const h=performance.now();requestAnimationFrame(u)}}else yt(a)},(e.length-1-s)*t)}}function Tt(r,e,t=1e3){r.forEach((i,s)=>{setTimeout(()=>{Mt(i.planet3d),s===r.length-1&&setTimeout(()=>{window.dispatchEvent(new CustomEvent("planetsInView"))},t)},s*t)})}function yt(r){return new Promise(e=>{r.traverse(t=>{if(t.isMesh||t.isLine){let a=function(n){const l=n-s,o=Math.min(l/200,1),h=1-o*o*(3-2*o);t.material.opacity=h,o<1?requestAnimationFrame(a):(t.visible=!1,e())};const s=performance.now();requestAnimationFrame(a)}})})}function Mt(r){r.visible=!0,r.traverse(e=>{if((e.isMesh||e.isLine)&&e.material){let a=function(n){const l=n-s,o=Math.min(l/i,1),h=o*o*(3-2*o);t.forEach(u=>{u.opacity=h}),o<1&&requestAnimationFrame(a)};e.visible=!0;const t=Array.isArray(e.material)?e.material:[e.material];t.forEach(n=>{n.transparent=!0,n.opacity=0,n.depthWrite===!1&&(n.depthWrite=!0),n.color&&n.color.a!==void 0&&(n.color.a=1)});const i=800,s=performance.now();requestAnimationFrame(a)}})}function Dt({event:r,sun:e,planets:t,controls:i,camera:s,offsets:a,canvas:n}){const l=r.detail.index;let o;l==0?o=e:o=t[l-1],d.offset=a[l],o.planet.visible=!0,o.planet.traverse(u=>{u.visible=!0,u.material&&(u.material.transparent=!0,u.material.opacity=1)}),St(o,e,t);const h=new m;o.planet.getWorldPosition(h),i.target.copy(h),s.lookAt(h),d.targetCameraPosition.copy(h).add(s.position.clone().sub(h).normalize().multiplyScalar(d.offset)),s.position.copy(d.targetCameraPosition)}async function Et(r,e){d.isZoomingOut=!0,console.log("zoom out received!");const t=new CustomEvent("changeSunOpacity",{detail:{opacity:1,duration:2e3}});r.dispatchEvent(t),e.accelerationOrbit=1;const i=new CustomEvent("revealPlanets",{detail:{delay:1e3}});setTimeout(()=>{window.dispatchEvent(i)},500)}function Ct(r,e,t){const i=window.devicePixelRatio||1,s=window.innerWidth,a=window.innerHeight;r.setSize(s,a,!0),e.aspect=s/a,e.updateProjectionMatrix(),t&&t.material.uniforms.resolution.value.set(1/(s*i),1/(a*i))}const ne=[90,30,40,30,30,65,90],X=new m(-175,115,5);function Pt({canvas:r,renderer:e,camera:t,fxaaPass:i,sun:s,planets:a,controls:n}){r.addEventListener("changeSunOpacity",l=>bt(s.material,l.detail.opacity,l.detail.duration)),r.addEventListener("hideOutofViewPlanets",l=>wt(l.detail.selectedPlanet,a,l.detail.delay)),window.addEventListener("zoomOutNeeded",()=>{Et(r,A)}),window.addEventListener("beginSunrise",()=>{_t(s)}),window.addEventListener("solarTransformDownZoomOutCue",()=>{xt(s)}),window.addEventListener("revealPlanets",l=>{Tt(a,d.hoverEnabled,l.detail.delay)}),window.addEventListener("resize",Ct(e,t,i)),window.addEventListener("planetChange",l=>{Dt({event:l,sun:s,planets:a,controls:n,camera:t,offsets:ne,canvas:r})})}const le=(r,e,t,i,s,a,n)=>{r.rotateY(.0015);for(const o of e)o.rotateSelf(o.planet,o.rotationSpeed,A.acceleration),o.planet3d.rotateY(o.orbitSpeed*A.accelerationOrbit);if(d.hasMouseMove){t.raycaster.setFromCamera(d.mouse,s);var l=t.raycaster.intersectObjects(t.raycastTargets);if(i.selectedObjects=[],l.length>0){const o=l[0].object;i.selectedObjects=[o]}}d.isMovingTowardsPlanet?(s.position.lerp(d.targetCameraPosition,.03),s.position.distanceTo(d.targetCameraPosition)<1&&(d.isMovingTowardsPlanet=!1)):d.isZoomingOut&&(s.position.lerp(X,.03),s.position.distanceTo(X)<1&&(d.isZoomingOut=!1,d.hoverEnabled=!0)),a.update(),n.render(),requestAnimationFrame(()=>le(r,e,t,i,s,a,n))};async function Ot(){he(!1)}async function Rt(){he(!0)}async function he(r){const{scene:e,camera:t,renderer:i,controls:s,canvas:a}=it(),{composer:n,outlinePass:l,fxaaPass:o}=st(i,e,t);at(e);const h=ut(),u=await ct();rt(e,h,u),r||(ht(h),lt(u));const v=new pt({sun:h,planets:u,camera:t,controls:s,outlinePass:l,offsets:ne,canvas:a});v.attach(),le(h,u,v,l,t,s,n),Pt({canvas:a,renderer:i,camera:t,fxaaPass:o,sun:h,planets:u,controls:s})}export{Rt as initDevSolarSystem,Ot as initHomepageSolarSystem};
//# sourceMappingURL=solarSystemMain-51-MQIts.js.map
