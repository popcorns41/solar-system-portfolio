/**
 * postprocessing v7.0.0-beta.11 build Sun May 18 2025
...
import { SRGBColorSpace as SRGBColorSpace2 } from "three";
...
import { EventDispatcher as EventDispatcher5, UnsignedByteType as UnsignedByteType2 } from "three";
...
var Output = class _Output extends EventDispatcher5 {
  ...
  get frameBufferPrecisionHigh() {
    ...
    return outputBuffer.texture.type !== UnsignedByteType2;
  }
  /**
   * Dispatches a `change` event.
   *
...
var FullscreenMaterial = class extends ShaderMaterial {
  ...
  constructor(parameters) {
    ...
    Object.assign(this.uniforms, {
      projectionMatrix: new Uniform3(null),
      projectionMatrixInverse: new Uniform3(null),
      viewMatrixInverse: new Uniform3(null),
      cameraParams: new Uniform3(new Vector3()),
      resolution: new Uniform3(new Vector4()),
  ...
  set inputBuffer(value) {
    this.frameBufferPrecisionHigh = value !== null && value.type !== UnsignedByteType3;
...
import { EventDispatcher as EventDispatcher6, Vector2 } from "three";
var AUTO_SIZE = -1;
var Resolution = class extends EventDispatcher6 {
  /**
...
var SceneEventTarget = class extends EventDispatcher7 {
  /**
...
var Pass = class _Pass extends EventDispatcher8 {
  ...
  constructor(name) {
    ...
    this.previousDefines = /* @__PURE__ */ new Map();
    this.previousUniforms = /* @__PURE__ */ new Map();
   ...
   */
  updateFullscreenMaterialInput() {
    const fullscreenMaterial = this.fullscreenMaterial;
    if (!(fullscreenMaterial instanceof RawShaderMaterial || fullscreenMaterial instanceof ShaderMaterial2)) {
      return;
    }
   ...
   */
  updateFullscreenMaterialOutput() {
...
var Background = class extends Group {
  /**
   * A sky box.
   */
  skyBox;
  ...
  setClearValues(values) {
    ...
    for (const entry of values.gBuffer) {
      uniforms.set(`pp_${entry[0]}`, new Uniform5(entry[1]));
...
var ClearFlags = class {
  ...
  constructor(color2 = true, depth = true, stencil = true) {
    const gBuffer = /* @__PURE__ */ new Set();
    gBuffer.add("Normal" /* NORMAL */);
    gBuffer.add("ORM" /* ORM */);
    gBuffer.add("Emission" /* EMISSION */);
    this.gBuffer = gBuffer;
    this.color = color2;
    this.depth = depth;
...
import { EventDispatcher as EventDispatcher9, Vector4 as Vector42 } from "three";
var ClearValues = class extends EventDispatcher9 {
  ...
  constructor() {
    ...
    const gBuffer = new ObservableMap([
      ["Normal" /* NORMAL */, new Vector42(0.5, 0.5, 1, 1)],
      ["ORM" /* ORM */, new Vector42(1, 0, 0, 1)],
      ["Emission" /* EMISSION */, new Vector42(0, 0, 0, 1)]
    ]);
...
var GBufferConfig = class extends EventDispatcher10 {
  ...
  constructor() {
    ...
    const gBufferStructDeclaration = new ObservableMap([
      ...
      ["emission" /* EMISSION */, "FRAME_BUFFER_PRECISION sampler2D emission;"]
    ]);
    ...
    const gDataStructInitialization = new ObservableMap([
      ...
      ["depth" /* DEPTH */, "gData.depth = texture(gBuffer.depth, UV).r;"],
      ["normal" /* NORMAL */, "gData.normal = texture(gBuffer.normal, UV).xyz;"],
...
import { AlwaysDepth, Uniform as Uniform6 } from "three";
...
var GeometryPass = class extends Pass {
  ...
  updateOutputBufferColorSpace() {
    ...
    const useSRGB = this.frameBufferType === UnsignedByteType5 && renderer.outputColorSpace === SRGBColorSpace;
  ...
  updateGBuffer() {
    ...
    const renderTarget = new WebGLRenderTarget4(width, height, {
...
var IOManager = class _IOManager {
  ...
  static syncDefaultBufferType(pipeline) {
    for (const pass of pipeline.passes.filter((x) => x.enabled)) {
      ...
      if (!pass.input.frameBufferPrecisionHigh && pipeline.renderer?.outputColorSpace === SRGBColorSpace2) {
        outputBuffer.texture.colorSpace = SRGBColorSpace2;
      }
...
import { Vector2 as Vector24, Vector4 as Vector43 } from "three";
...
var gbuffer_default_output_default = `#ifdef out_Normal
out_Normal=vec4(0.0);
#endif
#ifdef out_ORM
out_ORM=vec4(0.0);
...
var ShaderChunkExtensions = class {
  ...
  static register() {
    ...
    ShaderLib3.background.fragmentShader = ShaderLib3.background.fragmentShader.replace(
...
import { EventDispatcher as EventDispatcher11, Uniform as Uniform7 } from "three";
var BlendMode = class extends EventDispatcher11 {
  ...
  constructor(blendFunction, opacity = 1) {
    ...
    this.opacityUniform = new Uniform7(opacity);
  }
  /**
...
import { Color as Color3, Uniform as Uniform8, Vector4 as Vector44 } from "three";
...
var ASCIIEffect = class extends Effect {
  ...
  constructor({
    ...
    uniforms.set("asciiTexture", new Uniform8(null));
    uniforms.set("cellCount", new Uniform8(new Vector44()));
    uniforms.set("color", new Uniform8(new Color3()));
    this._cellSize = -1;
...
var LuminanceMaterial = class extends FullscreenMaterial {
  ...
  constructor() {
    super({
      ...
      vertexShader: common_default,
      uniforms: {
        threshold: new Uniform9(0),
        smoothing: new Uniform9(0)
      }
    });
  }
  /**
  ...
  set threshold(value) {
    this.thresholdEnabled = this.smoothing > 0 || value > 0;
  ...
  set smoothing(value) {
    this.thresholdEnabled = this.threshold > 0 || value > 0;
...
import { Uniform as Uniform10, Vector2 as Vector25 } from "three";
...
var UpsamplingMaterial = class extends FullscreenMaterial {
  ...
  constructor({ radius = 0.85 } = {}) {
    super({
      ...
      uniforms: {
        supportBuffer: new Uniform10(null),
        texelSize: new Uniform10(new Vector25()),
        radius: new Uniform10(0)
      }
    });
    this.radius = radius;
  }
...
#endif
uniform float intensity;vec4 mainImage(const in vec4 inputColor,const in vec2 uv,const in GData gData){vec3 texel=texture(map,uv).rgb;return vec4(texel*intensity,inputColor.a);}`;
...
var BloomEffect = class extends Effect {
  ...
  constructor({
    ...
    const uniforms = this.input.uniforms;
    uniforms.set("intensity", new Uniform11(intensity));
    uniforms.set("map", new Uniform11(null));
...
import { Uniform as Uniform12, Vector3 as Vector32 } from "three";
...
var ColorDepthEffect = class extends Effect {
  ...
  constructor({ r = 16, g = 16, b = 16 } = {}) {
    ...
    const uniforms = this.input.uniforms;
    uniforms.set("colorRanges", new Uniform12(new Vector32()));
...
import { Uniform as Uniform13, Vector3 as Vector33 } from "three";
...
var HalftoneEffect = class extends Effect {
  ...
  constructor({
    ...
    const uniforms = this.input.uniforms;
    uniforms.set("radius", new Uniform13(1));
    uniforms.set("rotationRGB", new Uniform13(new Vector33(rotationR, rotationG, rotationB)));
    uniforms.set("scatterFactor", new Uniform13(scatterFactor));
    this._radius = radius;
    this.shape = shape;
    this.samples = samples;
...
import { Uniform as Uniform14, Vector2 as Vector26 } from "three";
...
var LensDistortionEffect = class extends Effect {
  ...
  constructor({
    ...
    const uniforms = this.input.uniforms;
    uniforms.set("distortion", new Uniform14(distortion));
    uniforms.set("principalPoint", new Uniform14(principalPoint));
    uniforms.set("focalLength", new Uniform14(focalLength));
    uniforms.set("skew", new Uniform14(skew));
  }
  get distortion() {
...
import { FloatType as FloatType2, HalfFloatType as HalfFloatType3, Uniform as Uniform15 } from "three";
...
var LUT1DEffect = class extends Effect {
  ...
  constructor({ lut = null } = {}) {
    ...
    this.input.uniforms.set("lut", new Uniform15(null));
    this.lut = lut;
  }
  /**
  ...
  set lut(value) {
    ...
    this.lutPrecisionHigh = value?.type === FloatType2 || value?.type === HalfFloatType3;
  }
};
...
var LUT3DEffect = class extends Effect {
  ...
  constructor({
    ...
    const uniforms = this.input.uniforms;
    uniforms.set("lut", new Uniform16(null));
    uniforms.set("scale", new Uniform16(new Vector34()));
    uniforms.set("offset", new Uniform16(new Vector34()));
    uniforms.set("domainMin", new Uniform16(null));
    uniforms.set("domainMax", new Uniform16(null));
  ...
  set lut(value) {
    ...
    this.lutPrecisionHigh = value.type === FloatType3 || value.type === HalfFloatType4;
...
var NoiseEffect = class extends Effect {
  ...
  constructor({
    ...
    this.input.uniforms.set("page", new Uniform17(1));
...
import { Uniform as Uniform18, Vector2 as Vector27 } from "three";
...
var ScanlineEffect = class extends Effect {
  ...
  constructor({
    ...
    const uniforms = this.input.uniforms;
    uniforms.set("params", new Uniform18(new Vector27(offset, 0)));
    uniforms.set("scrollSpeed", new Uniform18(0));
...
import { Uniform as Uniform19, UnsignedByteType as UnsignedByteType6 } from "three";
  ...
  constructor() {
    super({
      ...
      uniforms: {
        ...
        predicationBuffer: new Uniform19(null)
      }
    });
  }
  /**
...
var SMAAWeightsMaterial = class extends FullscreenMaterial {
  ...
  constructor() {
    super({
      ...
      uniforms: {
        searchTexture: new Uniform20(null),
        areaTexture: new Uniform20(null)
      }
    });
  }
  /**
...
var SMAAEffect = class _SMAAEffect extends Effect {
  ...
  */
  ...
  constructor({
    ...
    this.input.uniforms.set("weightMap", new Uniform21(null));
  ...
  applyPreset(preset) {
    ...
    switch (preset) {
      case 0 /* LOW */:
        ...
        break;
      case 1 /* MEDIUM */:
        edgeDetectionMaterial.edgeDetectionThreshold = 6e-3;
      ...
      case 2 /* HIGH */:
        ...
        break;
      case 3 /* ULTRA */:
        edgeDetectionMaterial.edgeDetectionThreshold = 4e-3;
...
import { Uniform as Uniform22, UnsignedByteType as UnsignedByteType7 } from "three";
...
var TextureEffect = class extends Effect {
  ...
  constructor({ texture = null } = {}) {
    ...
    const uniforms = this.input.uniforms;
    uniforms.set("map", new Uniform22(null));
    uniforms.set("uvTransform", new Uniform22(null));
...
import { Color as Color5, Uniform as Uniform23, Vector2 as Vector28 } from "three";
...
var VignetteEffect = class extends Effect {
  ...
  constructor({
    ...
    const uniforms = this.input.uniforms;
    uniforms.set("offsetFeather", new Uniform23(new Vector28(offset, feather)));
    uniforms.set("color", new Uniform23(new Color5(color2)));
  }
  get technique() {
...
var AdaptiveLuminanceMaterial = class extends FullscreenMaterial {
  ...
  constructor() {
    super({
      ...
      uniforms: {
        luminanceBuffer0: new Uniform24(null),
        luminanceBuffer1: new Uniform24(null),
        minLuminance: new Uniform24(0.01),
        deltaTime: new Uniform24(0),
        tau: new Uniform24(1)
      }
    });
  }
...
var BokehMaterial = class extends FullscreenMaterial {
  ...
  constructor(fill = false, foreground = false) {
    super({
      ...
      uniforms: {
        cocBuffer: new Uniform25(null),
        kernel64: new Uniform25(null),
        kernel16: new Uniform25(null),
  ...
  constructor({ bilateral = false, kernelSize = 5 } = {}) {
    super({
      ...
      uniforms: {
        ...
        normalDepthBuffer: new Uniform26(null),
        scale: new Uniform26(1)
      }
    });
...
// src/materials/shaders/gbuffer-debug.frag
var gbuffer_debug_default = `#include <common>
#include <dithering_pars_fragment>
#include <packing>
#include <pp_camera_pars_fragment>
#include <pp_default_output_pars_fragment>
...
var BufferDebugMaterial = class extends FullscreenMaterial {
  ...
  constructor() {
    super({
      ...
      fragmentShader: gbuffer_debug_default,
      vertexShader: common_default,
      uniforms: {
   ...
   */
  get reconstructPosition() {
    return this.defines.RECONSTRUCT_POSITION !== void 0;
  }
  set reconstructPosition(value) {
  ...
  constructor() {
    super({
      ...
      uniforms: {
        ...
        focusDistance: new Uniform28(0),
        focusRange: new Uniform28(0)
      }
    });
  }
  /**
...
import { Uniform as Uniform29, Vector2 as Vector29 } from "three";
...
var DepthCopyMaterial = class extends FullscreenMaterial {
  ...
  constructor() {
    super({
      ...
      uniforms: {
        depthBuffer: new Uniform29(null),
        texelPosition: new Uniform29(new Vector29())
      }
    });
  }
  /**
...
var DepthDownsamplingMaterial = class extends FullscreenMaterial {
  ...
  constructor() {
    super({
      ...
      uniforms: {
        depthBuffer: new Uniform30(null),
        normalBuffer: new Uniform30(null)
      }
    });
  }
  /**
...
var EffectMaterial = class extends FullscreenMaterial {
  ...
  constructor() {
    super({
      ...
      uniforms: {
        gBuffer: new Uniform31(null),
        time: new Uniform31(0)
      }
    });
    this.customUniforms = /* @__PURE__ */ new Map();
    this.customDefines = /* @__PURE__ */ new Map();
...
import { Uniform as Uniform32, Vector2 as Vector210 } from "three";
...
var GaussianBlurMaterial = class extends FullscreenMaterial {
  ...
  constructor({ kernelSize = 35 } = {}) {
    super({
      ...
      uniforms: {
        direction: new Uniform32(new Vector210()),
        kernel: new Uniform32(null),
        scale: new Uniform32(1)
      }
    });
    this._kernelSize = 0;
    this.kernelSize = kernelSize;
...
import { Uniform as Uniform33 } from "three";
...
var KawaseBlurMaterial = class extends FullscreenMaterial {
  ...
  constructor() {
    super({
      ...
      uniforms: {
        scale: new Uniform33(1),
        kernel: new Uniform33(0)
      }
    });
...
import { Uniform as Uniform34, UnsignedByteType as UnsignedByteType8 } from "three";
...
var MaskMaterial = class extends FullscreenMaterial {
  ...
  constructor(maskTexture = null) {
    super({
      ...
      uniforms: {
        maskTexture: new Uniform34(maskTexture),
        strength: new Uniform34(1)
      }
    });
  }
  /**
...
import { Uniform as Uniform35, Vector2 as Vector211, Vector4 as Vector45 } from "three";
...
var TiltShiftBlurMaterial = class extends KawaseBlurMaterial {
  ...
  constructor({
    ...
    this.uniforms.aspect = new Uniform35(1);
    this.uniforms.rotation = new Uniform35(new Vector211());
    this.uniforms.maskParams = new Uniform35(new Vector45());
    this._offset = offset;
...
import { FloatType as FloatType4, NearestFilter as NearestFilter4, WebGLRenderTarget as WebGLRenderTarget6 } from "three";
...
import { FloatType as FloatType5, NearestFilter as NearestFilter5, WebGLRenderTarget as WebGLRenderTarget7 } from "three";
...
var DepthPickingPass = class extends DepthCopyPass {
  ...
  readDepthAt(x, y) {
    ...
    return this.renderer.capabilities.reverseDepthBuffer ? 1 - pixelBuffer[0] : pixelBuffer[0];
  }
  /**
...
var EffectShaderData = class {
   ...
   */
  constructor(gBufferConfig = null) {
...
`;
  ...
  createGBufferStruct() {
    return [
      "struct GBuffer {",
      ...Array.from(this.gBufferConfig.gBufferStructDeclaration).filter((x) => this.gData.has(x[0])).map((x) => `	${x[1]}`),
      "};\n"
    ].join("\n");
  }
  /**
   ...
   * @return The shader code.
   */
  createGDataStructDeclaration() {
    return [
      "struct GData {",
      ...Array.from(this.gBufferConfig.gDataStructDeclaration).filter((x) => this.gData.has(x[0])).map((x) => `	${x[1]}`),
      "};\n"
    ].join("\n");
  }
  /**
   ...
   * @return The shader code.
   */
  createGDataStructInitialization() {
...
var EffectMaterialManager = class _EffectMaterialManager {
  ...
  createMaterial(effects) {
    ...
    data.shaderParts.set("$FRAGMENT_HEAD_GDATA" /* FRAGMENT_HEAD_GDATA */, data.createGDataStructDeclaration());
    data.shaderParts.set("$FRAGMENT_MAIN_GDATA" /* FRAGMENT_MAIN_GDATA */, data.createGDataStructInitialization());
...
var LookupTexture = class _LookupTexture extends Data3DTexture {
  ...
  applyLUT(lut) {
    ...
    } else if (lut.type !== FloatType6 || this.type !== FloatType6) {
